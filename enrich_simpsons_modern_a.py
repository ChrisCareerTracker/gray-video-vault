...
ERA: Modern Era Part A — Seasons 21–28 (2009–2017)
Output: simpsons_modern_a.json
"""

import os, sys, json, time, re, requests

BASE = os.path.dirname(os.path.abspath(__file__))
OUT  = os.path.join(BASE, 'simpsons_modern_a.json')

TMDB_KEY      = '573382ec2121f69d6a89fce35293591a'
ANTHROPIC_KEY = os.environ.get('ANTHROPIC_API_KEY', '')
TMDB_SERIES   = 456

SEASONS = list(range(21, 29))   # 21–28
...
def main():
    print('='*60)
    print('SIMPSONS ENRICHMENT — MODERN ERA A (S21–S28)')
    print('='*60)
    ...
    print(f'\n{"="*60}')
    print(f'DONE — {len(episodes)} episodes written to simpsons_modern_a.json')
    print(f'{"="*60}')
