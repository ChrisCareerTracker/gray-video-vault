...
ERA: Middle Years — Seasons 13–20 (2001–2009)
Output: simpsons_middle.json
"""

import os, sys, json, time, re, requests

BASE = os.path.dirname(os.path.abspath(__file__))
OUT  = os.path.join(BASE, 'simpsons_middle.json')

TMDB_KEY      = '573382ec2121f69d6a89fce35293591a'
ANTHROPIC_KEY = os.environ.get('ANTHROPIC_API_KEY', '')
TMDB_SERIES   = 456

SEASONS = list(range(13, 21))   # 13–20
...
def main():
    print('='*60)
    print('SIMPSONS ENRICHMENT — MIDDLE YEARS (S13–S20)')
    print('='*60)
    ...
    output = {
        'era':        'middle',
        'era_label':  'The Middle Years',
        'seasons':    '13–20',
        'years':      '2001–2009',
        'description': 'The show reinvents itself. Bolder experiments, bigger guests, and the Movie arrives in 2007.',
    ...
    print(f'\n{"="*60}')
    print(f'DONE — {len(episodes)} episodes written to simpsons_middle.json')
    print(f'{"="*60}')
